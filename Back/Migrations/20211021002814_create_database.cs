...
{
    public partial class _create_database : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentVacancies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentVacancies_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentVacancies_Vacancies_VacancyId",
                        column: x => x.VacancyId,
                        principalTable: "Vacancies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubjectSkills_Subjects_SubjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentVacancies_StudentId",
                table: "StudentVacancies",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentVacancies_VacancyId",
                table: "StudentVacancies",
                column: "VacancyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubjectSkills_SubjectId",
                table: "SubjectSkills",
                column: "SubjectId");
